...
if( !class_exists( 'Trendz_Shop_Single_Module_Upsell_Related' ) ) {

    class Trendz_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( trendz_is_file_in_theme( __FILE__ ) ) {
                    return TRENDZ_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( trendz_is_file_in_theme( __FILE__ ) ) {
                    return TRENDZ_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'trendz_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('trendz_shop_single_module_upsell_related') ) {
	function trendz_shop_single_module_upsell_related() {
		return Trendz_Shop_Single_Module_Upsell_Related::instance();
	}
}

trendz_shop_single_module_upsell_related();
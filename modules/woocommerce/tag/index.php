...
if( !class_exists( 'Trendz_Woo_Listing_Tag' ) ) {

    class Trendz_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'trendz_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('trendz_woo_listing_tag') ) {
	function trendz_woo_listing_tag() {
		return Trendz_Woo_Listing_Tag::instance();
	}
}

trendz_woo_listing_tag();
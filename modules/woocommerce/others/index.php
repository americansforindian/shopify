...
if( !class_exists( 'Trendz_Woo_Others' ) ) {

    class Trendz_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'trendz_woo_others_settings', $this->settings );
...
if( !function_exists('trendz_woo_others') ) {
	function trendz_woo_others() {
		return Trendz_Woo_Others::instance();
	}
}

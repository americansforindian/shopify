...
if( !class_exists( 'Trendz_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Trendz_Woo_Listing_Option_Thumb_Element_Group extends Trendz_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'trendz_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('trendz_woo_listing_option_thumb_element_group') ) {
	function trendz_woo_listing_option_thumb_element_group() {
		return Trendz_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

trendz_woo_listing_option_thumb_element_group();
...
if( !class_exists( 'Trendz_Woo_Listing_Type_Default' ) ) {

    class Trendz_Woo_Listing_Type_Default {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Default', 'trendz');
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( trendz_is_file_in_theme( __FILE__ ) ) {
                    return TRENDZ_MODULE_DIR . '/woocommerce/listings/types/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( trendz_is_file_in_theme( __FILE__ ) ) {
                    return TRENDZ_MODULE_URI . '/woocommerce/listings/types/';
                } else {
        ...
        */
            function render_backend() {
                ...
                /* Custom Product Templates - Options */
                    add_filter( 'trendz_woo_default_product_templates', array( $this, 'woo_default_product_templates'), 10, 1 );
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    'id'              => 'trendz-woo-product-style-template-'.$this->type_slug,
                    'type'            => 'group',
                    'trendz_default_type' => true,
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'trendz' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'trendz'),
                    'accordion_title' => esc_html__('Add New Template', 'trendz'),
                    'fields'          => trendz_woo_listing_fw_template_settings()->woo_get_options_params( $type_options, 'default' ),
        ...
        */
            function set_type_options() {
                ...
                $type_options['product-overlay-bgcolor'] = 'rgba(232,233,229,0.6)';
                ...
                $type_options['product-border-type'] = '';
                ...
                $type_options['product-custom-class'] = 'wdt-custom-product-default';
        ...
        */
            function render_frontend() {
                ...
                if( $non_archive_listing ) {
                    ...
                    /* Types CSS */
                        add_filter( 'trendz_woo_non_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );

                } else {

                    /* Types CSS */
                        add_filter( 'trendz_woo_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'trendz-woo-non-archive', '', array (), TRENDZ_THEME_VERSION, 'all' );
                        wp_enqueue_style( 'trendz-woo-non-archive' );
                        ...
                        $css = apply_filters( 'trendz_woo_non_archive_css', $css );

                        if( !empty($css) ) {
                            wp_add_inline_style( 'trendz-woo-non-archive', $css );
                        }

                    // JS

                        wp_register_script( 'trendz-woo-non-archive', '', array ('jquery'), false, true );
                        wp_enqueue_script( 'trendz-woo-non-archive' );
                        ...
                        $js = apply_filters( 'trendz_woo_non_archive_js', $js );

                        if( !empty($js) ) {
                            wp_add_inline_script( 'trendz-woo-non-archive', $js );
                        }
...
if( !function_exists('trendz_woo_listing_type_default') ) {
	function trendz_woo_listing_type_default() {
		return Trendz_Woo_Listing_Type_Default::instance();
	}
}

trendz_woo_listing_type_default();
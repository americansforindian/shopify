...
/* Customized script - 'trendz_shop_products_list_class' function */
$columns = wc_get_loop_prop('columns');

$classes = apply_filters( 'trendz_woo_listings_class', array () );
...
if( !is_product() ) {
	if( function_exists ( 'trendz_woo_loop_column_class' ) ) {
		...
		<li class="product isotope-grid-sizer">
			<div class="<?php echo trendz_woo_loop_column_class ( $columns ); ?>"></div>
		</li>
		<?php
	}
}
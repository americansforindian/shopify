...
if( !class_exists( 'Trendz_Woo_Listing_Shop' ) ) {

    class Trendz_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'trendz_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('trendz_woo_listing_shop') ) {
	function trendz_woo_listing_shop() {
		return Trendz_Woo_Listing_Shop::instance();
	}
}

trendz_woo_listing_shop();